...
\begin{figure}[H]
\subfigure[\emph{"A Lion Rampant."}]{\includegraphics[width=0.5\textwidth]{blazon/images/rampant.eps}\cite{rampant}}
\hfill
\subfigure[\emph{"A Lion Passant"}]{\includegraphics[width=0.5\textwidth]{blazon/images/passant.eps}\cite{passant}}
\hfill
