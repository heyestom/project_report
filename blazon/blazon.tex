...
To define a crown in a Blazon sentence a quantifier pre-fix is used as a keyword immediately after the field the to be Charged is Tinctured. For example the Sentence \emph{"Vert a Crown Or"} Takes the implicit Field and Tinctures it \emph{Vert} before Charging the Field with a Crown Tinctured \emph{Or}, this would produce a green shield with a gold crown on it. 
...
Keywords do exist for more specific positioning of Charges such as \emph{"Beneath"} and \emph{"Above"} possible to 
