...
With Sub-Partitioning the set of valid Blazon sentences ceases to be finite, it is possible to repeatedly Partition a Field then Sub-Partition the new Sub-Fields and endlessly repeating this process.  Very complex patterns can now be created which are . 
f
\begin{figure}[H]
\subfigure[\emph{"A single empty Field."}]{\includegraphics[width=0.4\textwidth]{blazon/images/emptyfield.eps}}
\hfill
\subfigure[\emph{"The Field has been partitioned Per Bend"}]{\includegraphics[width=0.4\textwidth]{blazon/images/bend.eps}}
\hfill
\subfigure[\emph{"The Topmost Field has then been Sub partitioned Pale"}]{\includegraphics[width=0.4\textwidth]{blazon/images/subpartition4.eps}}
\hfill
\subfigure[\emph{"The Top Left most Sub-Field is Tinctured Sable"}]{\includegraphics[width=0.4\textwidth]{blazon/images/subpartition5.eps}}
\hfill
\end{figure}

\begin{figure}[H]
\ContinuedFloat
\subfigure[\emph{"The remaining Field is Sub-Partitioned Fess"}]{\includegraphics[width=0.4\textwidth]{blazon/images/subpartition6.eps}}
\hfill
\subfigure[\emph{"The Top Left Most Sub-Field is Tinctured Or"}]{\includegraphics[width=0.4\textwidth]{blazon/images/subpartition7.eps}}
\hfill
\subfigure[\emph{"The remaining Sub-Field is Sub-Partitioned Fess"}]{\includegraphics[width=0.4\textwidth]{blazon/images/subpartition8.eps}}
\hfill
\subfigure[\emph{"The final Field is Tinctured Gules"}]{\includegraphics[width=0.4\textwidth]{blazon/images/perbendperpalesableandargentperfessorandgules.eps}}
\hfill
